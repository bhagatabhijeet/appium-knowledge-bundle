...
- **iOS environment requirements**: Local iOS automation requires macOS and the required Xcode tooling. See [Ways to set up Appium](setup-options.md) for how this constrains a Windows or Linux Appium host.
