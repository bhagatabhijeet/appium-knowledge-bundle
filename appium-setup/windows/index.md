...
Step-by-step Appium server setup on Windows, via the command line.

# Topics

* [Install Node.js and npm on Windows](install-nodejs.md) - Installing Node.js and npm on Windows, the prerequisite for installing the Appium server itself.
